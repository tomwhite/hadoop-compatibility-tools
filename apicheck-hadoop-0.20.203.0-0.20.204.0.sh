BASELINE_VERSION=0.20.203.0
NEW_VERSION=0.20.204.0
...
./apicheck.sh \
  ...
  --baseline-tar=http://archive.apache.org/dist/hadoop/core/hadoop-$BASELINE_VERSION/hadoop-${BASELINE_VERSION}rc1.tar.gz \
